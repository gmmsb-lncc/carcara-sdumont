...
MODEL_PATH="/scratch/dockvs/leon.costa/DeepSeek-V3-0324-GGUF/DeepSeek-V3-0324-UD-IQ2_XXS/DeepSeek-V3-0324-UD-IQ2_XXS-00001-of-00005.gguf"
...
for BATCH in "${BATCH_SIZES[@]}"; do
  ...
  OUTPUT_FILE="benchmark_deepseek_v3_iq2_xxs_b${BATCH}_ctx${CTX_SIZE}.jsonl"
