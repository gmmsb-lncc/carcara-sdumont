...
MODEL_PATH="/scratch/dockvs/leon.costa/DeepSeek-V3-0324-GGUF/DeepSeek-V3-0324-UD-IQ1_M/DeepSeek-V3-0324-UD-IQ1_M-00001-of-00004.gguf"
...
for BATCH in "${BATCH_SIZES[@]}"; do
  OUTPUT_FILE="benchmark_deepseek_v3_iq1_m_b${BATCH}_ctx${CTX_SIZE}.jsonl"
